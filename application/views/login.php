...
<div id="login-masyarakat" class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="320" data-menu-effect="menu-over">
	<div class="content mb-0">
		...
		<!-- <div class="input-style has-icon input-style-1 input-required">
			...
			<span>NIK</span>
			<input type="number" placeholder="NIK" name="nik" required="required">
		</div>
		<div class="row">
			<div class="col-6">
...
<div id="login-petugas" class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="320" data-menu-effect="menu-over">
	<div class="content mb-0">
		<h1 class="font-700 mb-0">Login</h1>
		<p class="font-11  mt-n1 mb-0">
		Login Petugas
		</p>
		<form action="<?=site_url('login/doLogin_petugas')?>" method="POST">
			<div class="input-style has-icon input-style-1 input-required">
			<i class="input-icon fa fa-lock font-11"></i>
			<span>NRP</span>
			<input type="number" placeholder="NRP" name="nrp" required="required">
		</div>
		<div class="row">
			<div class="col-6">
				<a data-menu="menu-signup" href="#" class="float-right font-10"></a>
			...
			<div class="col-6">
				<a data-menu="daftar-petugas" href="#" class="float-right font-10">Daftar Akun</a>
				<div class="clearfix"></div>
			</div>
		</div>
		<button type="submit" class="btn btn-full btn-m shadow-l rounded-s text-uppercase font-900 bg-green1-dark mt-4">LOGIN</button>
...
<div id="daftar-petugas" class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="370" data-menu-effect="menu-over">
	<div class="content mb-0">
		<h1 class="font-700 mb-0">Daftar</h1>
		<p class="font-11  mt-n1 mb-0">
		Daftar Untuk Petugas
		</p>
		<form action="<?=site_url('login/daftar_petugas')?>" method="POST">
			<div class="input-style has-icon input-style-1 input-required">
				<i class="input-icon fa fa-user font-11"></i>
				<span>Nama Lengkap</span>
				<input type="text" placeholder="Nama Lengkap" name="nama" required="required">
			...
			<p class="text-center pb-0 mb-n1 pt-1">
				<a href="#" data-menu="login-petugas" class="text-center font-11 color-gray2-dark">Sudah Punya Akun? Login Disini</a>
			</p>
			<button type="submit" class="btn btn-full btn-m shadow-l rounded-s text-uppercase font-900 bg-blue2-dark mt-4">Daftar</button>
		</form>
	</div>
</div>
