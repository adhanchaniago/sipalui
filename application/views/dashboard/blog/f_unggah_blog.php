                        ...
                        <div class="col-lg-12">
                            <form role="form" class="form-horizontal" id="formblog">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10"> -->
                                        <input class="form-control" name="metatitle" id="metatitle" type="hidden">
                                    <!-- </div>
                                </div>
                                <div class="form-group">
                                    <label for="metatag" class="col-sm-2 control-label">Meta tag</label>
                                    <div class="col-sm-10"> -->
                                        <input class="form-control" name="metatag" id="metatag" type="hidden">
                                    <!-- </div>
                                </div>
                                <div class="form-group">
                                    <label for="metadesc" class="col-sm-2 control-label">Meta Desc</label>
                                    <div class="col-sm-10"> -->
                                        <input class="form-control" name="metadesc" id="metadesc" type="hidden" value="SI PALUI"></input>
                                    <!-- </div>
                                </div> -->
