                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-tags fa-fw"></i> Penyelenggara<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="#"><i class="fa fa-angle-double-right fa-fw"></i> Kategori <span class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-angle-double-right fa-fw"></i> Data <span class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level">
                                            <li>
                                                <a href="JavaScript:void(0);" onclick="fUploadProduct();"><i class="fa fa-angle-double-right fa-fw"></i> Tambah Data</a>
                                            </li>
                                            <li>
                                                <a href="JavaScript:void(0);" onclick="dataProduct();"><i class="fa fa-angle-double-right fa-fw"></i> Data Produk</a>
                                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="JavaScript:void(0);" onclick="dataMasy();"><i class="fa fa-angle-double-right fa-fw"></i> Masyarakat</a>
                                    </li>
                                    <li>
                                        <a href="JavaScript:void(0);" onclick="dataUser();"><i class="fa fa-angle-double-right fa-fw"></i> Petugas</a>
                                    </li>
                                </ul>
                            </li>
