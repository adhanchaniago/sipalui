<div class="page-title page-title-small">
	<h2>
		<a href="<?=site_url('petugas/kepolisian')?>" data-back-button><i class="fa fa-arrow-left"></i></a><?=$title?>
	</h2>
</div>
...
<p class="font-10 mb-2 pb-1" style="margin-top: -40px;"><i class="fa fa-globe mr-2"></i><?=$detail->web?></p>
