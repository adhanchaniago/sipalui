<div class="page-title page-title-small">
	<h2>
		<a href="<?=site_url('mobile/menu')?>" data-back-button><i class="fa fa-arrow-left"></i></a><?=$title?>
	</h2>
</div>
...
<div class="list-group list-custom-small list-icon-0">
	...
	foreach($satker as $row): ?>
		<a href="<?=site_url('mobile/kepolisian_detail_view/'.$row->id_kepolisian)?>"><span><?= $row->nama; ?></span><i class="fa fa-angle-right"></i></a>
	<?php endforeach; ?>
</div>
