...
<div id="page">
	...
	<a href="<?=base_url('users/menu')?>" class="header-icon header-icon-1"><i class="fas fa-arrow-left"></i></a>
	<!-- <a href="#" data-toggle-theme class="header-icon header-icon-2 show-on-theme-dark"><i class="fas fa-sun"></i></a> -->
	</div>

	<div id="footer-bar" class="footer-bar-5">
	<a href="<?=base_url('users/menu')?>"><i data-feather="home" data-feather-line="1" data-feather-size="21" data-feather-color="blue2-dark" data-feather-bg="blue2-fade-light"></i><span>Menu</span></a>
	<a href="<?=base_url('users/berita')?>"><i data-feather="file" data-feather-line="1" data-feather-size="21" data-feather-color="red2-dark" data-feather-bg="red2-fade-light"></i><span>Berita</span></a>
	<a href="<?=base_url('users/profile')?>"><i data-feather="user" data-feather-line="1" data-feather-size="21" data-feather-color="gray2-dark" data-feather-bg="gray2-fade-light"></i><span>Profile</span></a>
	</div>
...
<script type="text/javascript">
    ...
    // function Menu(){
	   //  $.ajax({
    //         url: '<?php echo base_url('users/menu'); ?>',
    //         method: "POST",
